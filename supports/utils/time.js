...
function formatUnixTimestampToIST(timestamp) {
    ...
    const d = new Date(timestamp * 1000); // Convert seconds to milliseconds
    ...
    const month = String(d.getUTCMonth() + 1).padStart(2, '0'); // January is 0!
...
module.exports = { restructureUserRecentTests , formatDateTime , formatUnixTimestampToIST}